...
export class NeovimUnavailableError extends Schema.TaggedError<NeovimUnavailableError>()(
...
export class NeovimControlError extends Schema.TaggedError<NeovimControlError>()(
  "NeovimControlError",
  {
    message: Schema.String,
  },
...
export class NeovimFileNotFoundError extends Schema.TaggedError<NeovimFileNotFoundError>()(
...
export class TerminalReservedIdError extends Schema.TaggedError<TerminalReservedIdError>()(
